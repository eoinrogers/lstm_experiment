...
def getargs(): 
    ...
    return args.dataset, args.linkproto, args.destination, args.newdata
...
def build_new_dataset(dataset, linkset): 
...
def main(): 
    datadir, linkproto, destpath, newdir = getargs()
    ...
    new_dataset = build_new_dataset(dataset, linkset)
